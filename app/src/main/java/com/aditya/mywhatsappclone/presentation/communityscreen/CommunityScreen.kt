package com.aditya.mywhatsappclone.presentation.communityscreen
...
fun CommunityScreen() {
    ...
    val sampleCommunities = listOf(
        ...
        Communities(image = R.drawable.img, name = "Photography Level", member = "122 members"),
        Communities(image = R.drawable.img, "Traveller Tech", "222 members")
    )
